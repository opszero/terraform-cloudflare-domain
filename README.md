...
|------|-------------|------|---------|:--------:|
| <a name="input_access"></a> [access](#input\_access) | n/a | `list` | `[]` | no |
| <a name="input_domain"></a> [domain](#input\_domain) | domain for the webapp | `any` | n/a | yes |
| <a name="input_dynamodb"></a> [dynamodb](#input\_dynamodb) | n/a | `bool` | `false` | no |
| <a name="input_parking"></a> [parking](#input\_parking) | n/a | `bool` | `false` | no |
| <a name="input_records"></a> [records](#input\_records) | n/a | `list` | `[]` | no |
## Resources
